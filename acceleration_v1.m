function [X,lambda,it] = acceleration_v1(A,p,X_0,itmax,tol)
%function [X,lambda,it] = acceleration_v1(A,p,X_0,itmax,tol)
%Esegue il Metodo delle Iterazioni Ortogonali con accelerazione di Rayleigh-Ritz nella prima versione, determinando le p autocoppie dominanti della matrice A a partire dalla matrice con colonne ortonormali X_0. 
%IN INPUT
