function [X,lambda,it] = ritzritz(A,p,X_0,itmax,tol)
%function [X,lambda, it] = ritzritz(A,p,X_0,itmax,tol)
%Esegue il Metodo delle Iterazioni Ortogonali con accelerazione di Rayleigh-Ritz usando l'algoritmo ritritz. Determina le p autocoppie dominanti della matrice A a partire dalla matrice con colonne ortonormali X_0. 
%IN INPUT
